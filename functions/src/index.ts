...
// *****************Node.js Quickstart From https://developers.google.com/admin-sdk/directory/v1/quickstart/nodejs?authuser=6
...
function storeToken(token:any) {
  fs.writeFile(TOKEN_PATH, JSON.stringify(token), (err:any) => {
    if (err) return 
    console.warn(`Token not stored to ${TOKEN_PATH}`, err);
